...
using namespace std;
/*
bool AcceptTrustFiNetworkTransaction(const CTransaction& tx, 
                            ...
                            if(ptr)
                            {
                                ...
                                while(ptr<ptrEnd)
                                {
                                    ...
                                    if(param.m_Param)
                                    {
                                        ...
                                        if(vUpgrades == NULL)                   // Called from TrustFiNetworkNode_ApplyUpgrades
                                        {
        ...
        if(pool.exists(hash))
        {
            ...
            else
            {
                ...
                if(entry.FullReplayRequired())
                {
                    ...
                    if(!AcceptTrustFiNetworkTransaction(tx,view,-1,accept ? MC_AMT_DEFAULT : MC_AMT_NO_ACCEPT,reason,NULL,NULL))
                    {
